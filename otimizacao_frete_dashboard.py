  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .sim-card-delta {{
      ...
      font-weight: 700;
      color: #ffcf9e;
      background: rgba(112, 62, 21, 0.25);
    ...
    .sim-card-delta.base {{
      color: #a9f2c7;
      background: rgba(18, 88, 54, 0.25);
      border-color: rgba(66, 194, 126, 0.35);
    }}
...
<body>
  ...
  <script>
    ...
    function simularCargaFrontend() {{
      ...
      resultEl.classList.add('visible');
      const custoBase = Number(cenariosCompetitivos[0]?.custoTotal || 0);
